...
public class Tab7 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        webView.setWebViewClient(new Tab7.MyBrowser());
        webView.getSettings().setJavaScriptEnabled(true);
        webView.loadUrl("https://www.shutterstock.com/search/"+ActivityThree.name+"?image_type=all&search_source=base_related_searches&language=en");
        return rootView;}
